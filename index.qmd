...
::: callout-important
Workflow4experimenters (![](/images/W4E_icon.svg){height="1em"}) course 2025 : [Pre-registration are open !!](https://jsaintvanne.github.io/workflow4metabolomics/W4E/w4e2025.html)
:::
...
<div class="card-group">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">I'm a newcomer and I want to know more about <img src="/images/W4M_icon.svg" style="height:20px">, visit our <a href="galaxyW4M.qmd">Introduction section</a> and <a href="tooluser.qmd">Guide for Users</a></p>
    </div>
  </div>
  <div class="card">
...
<div class="card-group">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">
      <ul class="list-group list-group-flush">
        <li class="list-group-item"><small><b>A tutor</b> to help people understand how to process metabolomics data <a href="new.qmd">see here</a></small></li>
