...
::: callout-important
Workflow4experimenters (![](/images/W4E_icon.svg){height="1em"}) course 2025 : [Will open soon (1st of December 2024)](https://jsaintvanne.github.io/workflow4metabolomics/W4E/w4e2025.html)
:::
...
for(r in 1:nrow(people)){
  ref <- paste0('<b><a href=',paste0('/people/W4Mteam/',strsplit(people$people[r]," ")[[1]][1],'_',strsplit(people$people[r]," ")[[1]][2], '.html>', people$people[r], '</a></b> <br>', people$lab[r]))
  label <- c(label, ref)
}
